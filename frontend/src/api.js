const API_URL = 'https://surya-yif7.onrender.com/api';
const getHeaders = () => ({
...
export const api = {
  ...
  referralStats: () =>
    fetch(`${API_URL}/auth/referral-stats`, { headers: getHeaders() }).then(r => r.json()),
  ...
  adminReferrals: () =>
    fetch(`${API_URL}/admin/referrals`, { headers: getHeaders() }).then(r => r.json()),
